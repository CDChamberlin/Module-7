...
function Clock() {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      clearInterval(clockInterval); //stops the interval from running on "unmounting of Clock component"
      clearTimeout(); // stops the timeout when component is unmounted.
    };
